...
<section class="flex items-center justify-center">
  <div class="w-full max-w-md rounded-3xl border border-slate-100 bg-white p-8 shadow-2xl shadow-indigo-500/10 dark:border-slate-800 dark:bg-slate-900">
    <div class="text-center">
      <p class="text-sm font-semibold text-indigo-600 dark:text-indigo-400">Welcome back</p>
      <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Log in to NovaRooms</h1>
      <p class="text-sm text-slate-500 dark:text-slate-400">Access your encrypted rooms and recent activity.</p>
    </div>
    <form class="mt-6 space-y-4">
      ...
      <label class="space-y-2 text-sm font-medium text-slate-700 dark:text-slate-300">
        Password
        <div class="relative">
          <input id="login-password" type="password" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-3 pr-12 text-sm text-slate-900 outline-none transition focus:border-indigo-200 focus:bg-white dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100" placeholder="••••••" />
          <button type="button" data-password-toggle="login-password" class="absolute inset-y-0 right-3 my-auto flex items-center text-slate-400" aria-label="Toggle password">
      ...
      <div class="flex items-center justify-between text-sm">
        <label class="flex items-center gap-2 text-slate-600 dark:text-slate-300"><input type="checkbox" class="h-4 w-4 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 dark:border-slate-700 dark:bg-slate-800" /> Remember me</label>
        <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">Forgot password?</a>
      </div>
      <button type="submit" class="w-full rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/30 transition hover:shadow-indigo-600/40">Log in</button>
      ...
      <p class="text-center text-sm text-slate-500 dark:text-slate-400">No account? <a href="signup.php" class="font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">Sign up</a></p>
    </form>
  </div>
</section>
<?php
